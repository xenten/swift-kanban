...
|| $canEdit): 
?>
<div class="article-tools clearfix blog-header-details">
    ...
    <div class="blog-social-buttons">
        ...
        <div class="blog-google-plus">
            <g:plusone size="medium" href="<?php echo "http://www.swift-kanban.com/".(JRoute::_(ContentHelperRoute::getArticleRoute($this->item->slug, $this->item->catid))); ?>"></g:plusone>
        </div>
        <div class="blog-linkedin-share">
            <script type="IN/Share" data-url="<?php echo "http://www.swift-kanban.com/".(JRoute::_(ContentHelperRoute::getArticleRoute($this->item->slug, $this->item->catid))); ?>" data-counter="right"></script>
        </div>
        <div class="blog-twitter-tweet">
            <a href="https://twitter.com/share" class="twitter-share-button"
               ...
               data-via="swiftkanban" data-text="<?php echo $this->escape($this->item->title); ?>" data-hashtags="kanban">&nbsp;</a>
        ...
        <div class="blog-facebook-share">
            <a rel="nofollow"
               href="http://www.facebook.com/share.php?u=<?php echo "http://www.swift-kanban.com/".(JRoute::_(ContentHelperRoute::getArticleRoute($this->item->slug, $this->item->catid))); ?>"
               class="fb_share_button" onclick="return fbs_click('<?php echo $this->escape($this->item->title); ?>',
                '<?php echo "http://www.swift-kanban.com/".(JRoute::_(ContentHelperRoute::getArticleRoute($this->item->slug, $this->item->catid))); ?>')"
...
?>
	<a class="readmore" href="<?php echo $link; ?>"><span>
