...
class fieldsattachViewfieldsattachunidades extends JView
{
	...
	{   
		...
		JToolBarHelper::title(JText::_('COM_FIELDATTACH_MANAGER_FIELDATTACHUNIDADES') 
                        ,'weblinks');
		...
		if ($canDo->get('core.delete')) 
		{
			...
			JToolBarHelper::custom('fieldsattachunidad.publish', 'publish.png', 'publish_f2.png', 'JTOOLBAR_PUBLISH', true);
			JToolBarHelper::custom('fieldsattachunidad.unpublish', 'unpublish.png', 'unpublish_f2.png', 'JTOOLBAR_UNPUBLISH', true); 
		}
		if ($canDo->get('core.admin')) 
		{
			JToolBarHelper::divider();
