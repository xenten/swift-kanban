...
$pkgs = array( 
		...
		'date.zip'=>'Plugin fieldsattachment Date' , 
...
<div style="border:1px dashed #494; background-color:#292; color:#FFF;  font-size:17px; margin:8px 0 8px 0; padding:5px;">Component install OK</div>
