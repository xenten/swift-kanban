...
<head>
    ...
    <script src="/media/system/js/admin-mootools-core.js" type="text/javascript"></script>
    <script src="/media/system/js/admin-mootools-more.js" type="text/javascript"></script>
