...
class fieldsattachControllerfieldsattachgroup extends JControllerForm
{
         ...
         public function publish( )
	{
                ...
                $model = $this->getModel('fieldsattachgroup');
                $table = $model->getTable('fieldsattachgroup');
                $table->publish($cid, 1);
                
                //$productTable =& JTable::getInstance('producto', 'Table'); 
               
                
                $link=  'index.php?option=com_fieldsattach&view=fieldsattachgroups';
