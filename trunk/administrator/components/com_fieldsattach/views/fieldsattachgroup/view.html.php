 ...
 * fieldsattach View
 */
class fieldsattachViewfieldsattachgroup extends JView
{
	/**
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title($isNew ? JText::_('COM_fieldsattach_MANAGER_fieldsattach_NEW', 'categories') : JText::_('COM_fieldsattach_MANAGER_fieldsattach_EDIT'), 'categories');
		...
		else
		{
			...
			JToolBarHelper::cancel('fieldsattachgroup.cancel', 'JTOOLBAR_CLOSE');
               ...
               // JToolBarHelper::custom('fieldsattachgroup.help', 'help.png', 'help.png', 'JTOOLBAR_HELP', false, true);
			
		//JToolBarHelper::help('JHELP_FIELDSATTACH_MANAGER_EDIT');
	}
	/**
