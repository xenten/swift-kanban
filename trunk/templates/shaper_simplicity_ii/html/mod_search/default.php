...
<form action="<?php echo JRoute::_('index.php');?>" method="post">
	<div class="mod-search<?php echo $moduleclass_sfx ?>">
		<?php
			...
			if ($button) :
				if ($imagebutton) :
					$button = '<input id="mod-search-button" type="image" value="'.$button_text.'" class="button'.$moduleclass_sfx.'" src="'.$img.'" onclick="this.form.searchword.focus();"/>';
				else :
