...
function psgiLtow() {
	if (psgiLtol || (1 == 1)) {
		var pswo = "menubar=0,location=0,scrollbars=auto,resizable=1,status=0,width=680,height=550";
...
function psgiLtsi(t) {
	...
	psgiLtpi();
	psgiLtlc = 0;
	var url = "http://messenger.providesupport.com/" + ((t == 2) ? "auto" : "chat") + "-invitation/digitemarketing.html?ps_s=" + psgiLtsid + "&ps_t=" + psgiLtn() + "";
	var d = document.getElementById('cigiLt');
	if (d != null) {
...
if (psgiLtd != null) {
	if (psgiLtol || (1 == 1) || (1 == 2)) {
		if (false) {
			psgiLtd.innerHTML = '<table style="display:inline" cellspacing="0" cellpadding="0" border="0"><tr><td align="center"><a href="#" onclick="psgiLtow(); return false;"><img name="psgiLtimage" src="http://image.providesupport.com/image/digitemarketing/online-171347933.png" width="95" height="35" border="0"></a></td></tr><tr><td align="center"><a href="http://www.providesupport.com/pb/digitemarketing" target="_blank"><img src="http://image.providesupport.com/lcbps.gif" width="140" height="17" border="0"></a></td></tr></table>';
		} else {
			psgiLtd.innerHTML = '<a href="#" onclick="psgiLtow(); return false;"><img name="psgiLtimage" src="http://image.providesupport.com/image/digitemarketing/online-171347933.png" width="95" height="35" border="0"></a>';
		}
	} else {
		psgiLtd.innerHTML = '';
	}
...
function psgiLtco() {
	...
	psgiLtol = (w1 & 1) != 0;
	psgiLtsb(psgiLtol ? "http://image.providesupport.com/image/digitemarketing/online-171347933.png" : "http://image.providesupport.com/image/digitemarketing/offline-1566850851.png");
	psgiLtscf((w1 & 2) != 0);
...
function psgiLtrc() {
	psgiLtct = psgiLtst("psgiLtrc()", psgiLtcp);
	try {
		psgiLtci.src = "http://image.providesupport.com/cmd/digitemarketing?" + "ps_t=" + psgiLtn() + "&ps_l=" + escape(document.location) + "&ps_r=" + escape(document.referrer) + "&ps_s=" + psgiLtsid + "" + "";
	} catch(e) {
	}
}
psgiLtrc();
var psgiLtcb = "http://image.providesupport.com/image/digitemarketing/online-171347933.png";
function psgiLtsb(b) {
	if (psgiLtcb != b) {
