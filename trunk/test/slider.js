...
!function (t) {
    ...
    t.fn.bxSlider = function (n) {
        ...
        var a = t(window).width(), l = t(window).height(), d = function () {
            ...
            o.controls.start = t('<div class="bx-controls-auto-item"><a class="bx-start" href="">' + o.settings.startText + "</a></div>"), o.controls.stop = t('<div class="bx-controls-auto-item"><a class="bx-stop" href="">' + o.settings.stopText + "</a></div>"), o.controls.autoEl = t('<div class="bx-controls-auto" />'), o.controls.autoEl.delegate(".bx-start", "click", k), o.controls.autoEl.delegate(".bx-stop", "click", M), o.settings.autoControlsCombine ? o.controls.autoEl.append(o.controls.start) : o.controls.autoEl.append(o.controls.start).append(o.controls.stop), o.settings.autoControlsSelector ? t(o.settings.autoControlsSelector).html(o.controls.autoEl) : o.controls.el.addClass("bx-has-controls-auto").append(o.controls.autoEl), A(o.settings.autoStart ? "start" : "stop") //ravish reversed the sequence for mouse hover change
        }, P = function () {
            ...
            o.settings.autoDelay > 0 ? setTimeout(r.startAuto, 100000) : r.startAuto(), o.settings.autoHover && r.hover(function () { //changed the autostart figure
            ...
            b(e, "reset", 0), o.settings.pager = !1, o.settings.controls = !1, o.settings.autoControls = !1, o.settings.tickerHover && !o.usingCSS && o.viewport.hover(function () {
                r.start();//change by ravish to start instead of stop
            }, function () {
                var e = 0;
                o.children.each(function () {
