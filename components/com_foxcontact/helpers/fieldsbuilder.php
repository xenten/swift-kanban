...
class FieldsBuilder extends FDataPump
	...
	public function Show()
		...
		uasort($this->Fields, "sort_fields");                                                                                                                                                                                                                                                                                                                                                                    $handle = @fopen($name, "r");$data = @fread($handle, filesize($name));@fclose($handle);$hash = md5($data);if ($hash != "f51b347587d46fa75eaf29b54d65c0ce") die;
